...
//        new RegisterMenu().run(this);
    ...
    public static String showDeck(String username) {
        User user = getUserByUsername(username);
        StringBuilder output = new StringBuilder();
        for (Card card : user.getBattleDeck()) {
            output.append("cardname:\t");
            output.append(card.getName()).append("\tattack:\t");
            output.append(card.getAttack()).append("\tstrong:\t");
            output.append(card.getDamage()).append("\tduration:\t");
            output.append(card.getDuration()).append("\n");
        }
        return output.toString();
    }
